...
from wtforms import (BooleanField, DateField,
                      ...
                      FileField, MultipleFileField, FloatField,
                       RadioField, SelectField,
                      SelectMultipleField, SubmitField, StringField,
                      TimeField,  PasswordField, TextAreaField,
                      FieldList
                     )
from wtforms.validators import NumberRange, Email
from wtforms.fields import  DateTimeLocalField,EmailField,IntegerRangeField,MonthField,SearchField,TelField,URLField,ColorField,DecimalRangeField
import datetime
import decimal
...
class QuickForm(FlaskForm):
    ...
    datetimelocal_f = DateTimeField('DateTimeLocal (format is local: DD/MM/YYYY, HH:MM)', default=datetime.datetime.today())
